...
class WanI2V:
    ...
    def __init__(
        ...
        """
        device_type = resolve_device_backend(device_type if device_type is not None else env_device_backend())
    ...
    def generate(self,
        ...
        # evaluation mode
        with device_autocast(self.device.type, dtype=self.param_dtype, enabled=(self.device.type != 'cpu')):
